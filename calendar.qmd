...
events <- ifelse(format(dates, "%w") %in% c(6, 0), "Weekend", NA)
events[c(11,15, 18, 22)] <- "Class"
events[8] <- "Holiday"
events[c(1, 4)] <- "Class canceled"
calendR(month = 12,
        #year = 2025,
        start = "M",
        special.days = events,
        special.col = c("green", "violet", "gold", "gray"),
        legend.pos = "bottom",
        pdf = F, 
        day.size = 3, 
        weeknames.size = 4, 
        ...
        text.size = 2.5,              
        text.col = "black",
        text = c("14:00-16:00", "14:00-16:00", "14:00-16:00", "14:00-16:00" ),
        text.pos = c(11,15, 18, 22))
```
